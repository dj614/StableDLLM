...
def main():
    ...
    ap.add_argument("--in_file",  type=str, default="/storage/v-mengnijia/LLaDA/hitab_reasoning_sft_str_modified.jsonl")
    ap.add_argument("--out_file", type=str, default="/storage/v-mengnijia/LLaDA/hitab_reasoning_sft_str_modified_processed.jsonl")
