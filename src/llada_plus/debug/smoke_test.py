...
Run (from repo root):
  ...
  PYTHONPATH=src python -m llada_plus.debug.smoke_test
"""
...
from llada_plus.data import LLaDADataset, collate_fn, sample_multi_from_jsonl
from llada_plus.diffusion import forward_process
