...
def parse_args():
    ...
    ap.add_argument("--model", type=str, choices=["llada", "mmada"], default="llada")
    ap.add_argument("--model_path", type=str, default=None, help="HF model path/name. Defaults to LLaDA-8B-Instruct when --model=llada.")
    ap.add_argument("--tokenizer_path", type=str, default=None, help="Tokenizer path/name. Defaults to --model_path.")
    ap.add_argument("--pad_token_id", type=int, default=None, help="Pad token id used for batch padding (optional).")
    ap.add_argument("--mask_token_id", type=int, default=None, help="Mask token id used by the diffusion process (optional).")
    # MMaDA-only config overrides (optional; mirrors MMaDA/training/train_mmada.py merge logic)
    ap.add_argument("--new_vocab_size", type=int, default=None)
    ap.add_argument("--llm_vocab_size", type=int, default=None)
    ap.add_argument("--llm_model_path", type=str, default=None)
    ap.add_argument("--codebook_size", type=int, default=None)
    ap.add_argument("--num_vq_tokens", type=int, default=None)
    ap.add_argument("--num_new_special_tokens", type=int, default=None)
